...
@interface TextAlertController () <UIAlertViewDelegate, UIActionSheetDelegate>
...
@implementation TextAlertController
...
{
    TextAlertController *alertController = [self alertControllerWithTitle:title message:message preferredStyle:preferredStyle];
...
{
    TextAlertController *alertController = [self alertControllerWithTitle:title message:message preferredStyle:preferredStyle actions:actions];
...
- (instancetype)copyWithZone:(NSZone *)zone
{
    TextAlertController *alertController = [[TextAlertController allocWithZone:zone] initWithTitle:self.title.copy message:self.message.copy preferredStyle:self.preferredStyle];
