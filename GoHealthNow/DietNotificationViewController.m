...
//  reminders
//
//  Created by John Wreford on 2015-10-13.
//  Copyright (c) 2015 John Wreford. All rights reserved.
//

#import "DietNotificationViewController.h"
...
@interface DietNotificationViewController () <UITextFieldDelegate>
...
@implementation DietNotificationViewController
...
-(void)setupMealDisplay{
    ...
    if ([components hour]>=5 && [components hour] < 10){
        self.lblMealType.text = [LocalizationManager getStringFromStrId:MSG_BREAKFAST];
    }
    else if ([components hour]>=11 && [components hour] < 13){
        self.lblMealType.text = [LocalizationManager getStringFromStrId:MSG_LUNCH];
    }
    
    else if ([components hour]>=17 && [components hour] < 20){
        self.lblMealType.text = [LocalizationManager getStringFromStrId:MSG_DINNER];
    }
    
    else {
        self.lblMealType.text = [LocalizationManager getStringFromStrId:MSG_SNACK];
    }
}
