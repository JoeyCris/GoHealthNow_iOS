//
//  ChooseSpecialIDCodeViewController.m
//  GlucoGuide
//
//eserved.
//
...
@interface ChooseSpecialIDCodeViewController () <UINavigationBarDelegate, UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation ChooseSpecialIDCodeViewController
...
- (IBAction)textFieldDoneEditing:(UITextField *)textf{
    self.initialSpecialIDCode = textf.text;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        self.accesscodeTextField = (UITextField *)[cell viewWithTag:ACCESS_CODE_TAG_ACCESS_CODE2];
        
        self.accesscodeTextField.clearButtonMode = UITextFieldViewModeWhileEditing;
        self.accesscodeTextField.text = self.initialSpecialIDCode;
        ...
        lblUsage.text = [LocalizationManager getStringFromStrId:@"If your organization requires you to use a specific ID Code, please enter it above. If not, please leave blank"];
