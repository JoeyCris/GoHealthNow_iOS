...
//! Project version number for TextAlertController.
FOUNDATION_EXPORT double ARAlertControllerVersionNumber;

//! Project version string for TextAlertController.
...
#pragma mark - TextAlertController

/**
 *  A TextAlertController object displays an alert message to the user. This class replaces the UIActionSheet and UIAlertView classes for displaying alerts. After configuring the alert controller with the actions and style you want, present it using the presentInViewController:animated:completion: method
 */
@interface TextAlertController : NSObject <NSCopying>
