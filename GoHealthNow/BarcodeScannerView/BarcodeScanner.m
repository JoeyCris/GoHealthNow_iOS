...
@interface BarcodeScanner () <AVCaptureMetadataOutputObjectsDelegate>
/*!
 @property session
 @abstract
...
- (void)startScanningWithResultBlock:(void (^)(NSArray *codes))resultBlock {
    NSAssert([BarcodeScanner cameraIsPresent], @"Attempted to start scanning on a device with no camera. Check requestCameraPermissionWithSuccess: method before calling startScanningWithResultBlock:");
    NSAssert(![BarcodeScanner scanningIsProhibited], @"Scanning is prohibited on this device. \
